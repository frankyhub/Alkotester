/*************************************************************************************************
                                      PROGRAMMINFO
**************************************************************************************************
Funktion: I2C-NANO Display-Test SSD1306
...
void loop(void)
{
  ...
  u8x8.drawString(0, 0, "ABCDEFGH");

  u8x8.setFont(u8x8_font_px437wyse700b_2x2_r);
  u8x8.drawString(0, 2, "12345678");

  u8x8.setFont(u8x8_font_px437wyse700a_2x2_r);
  u8x8.drawString(0, 4, "ABCDEFGH");

  u8x8.setFont(u8x8_font_px437wyse700b_2x2_r);
  u8x8.drawString(0, 6, "12345678");

  u8x8.setFont(u8x8_font_px437wyse700a_2x2_r);
  u8x8.drawString(0, 8, "ABCDEFGH");

  u8x8.setFont(u8x8_font_px437wyse700b_2x2_r);
  u8x8.drawString(0, 10, "12345678");

  u8x8.setFont(u8x8_font_px437wyse700a_2x2_r);
  u8x8.drawString(0, 12, "ABCDEFGH");

  u8x8.setFont(u8x8_font_px437wyse700b_2x2_r);
  u8x8.drawString(0, 14, "12345678");
